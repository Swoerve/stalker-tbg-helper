                            ...
                            <v-overlay v-model="overlay" class="align-center justify-center">
                                <v-card class="pa-3" width="250">
                                    ...
                                    <v-form @submit.prevent="submit">
                                        <v-text-field contained="true" name="name" label="Name" placeholder="name"
                                            style="min-width: 10rem;" v-model="contactName"
                                            :rules="contactNameRule"></v-text-field>
                                        <v-text-field contained="true" name="card" label="Card" placeholder="C00"
                                            style="min-width: 10rem;" v-model="contactCard"
                                            :rules="contactCardRule"></v-text-field>

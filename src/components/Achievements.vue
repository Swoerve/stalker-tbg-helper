<template>
    <v-container>
        ...
        <v-row>
            <v-col v-for="(item, index) in stalker.achievements"
            :key="index"
            cols="6"
            >
                        ...
                        <v-overlay v-model="overlay" class="align-center justify-center">
                            <v-card class="pa-3" width="250">
                                ...
                                <v-form @submit.prevent="submit">
                                    ...
                                    v-model.trim="achievementTitle"
                                    :rules="achievementTitleRule"></v-text-field>
                                    <v-textarea
                                    label="Description"
                                    v-model.trim="achievementDescription"
                                    :rules="achievementDescRule">
                                    </v-textarea>
                                    ...
                                    placeholder="reward"
                                    style="min-width: 10rem;"
                                    v-model.trim="achievementReward"

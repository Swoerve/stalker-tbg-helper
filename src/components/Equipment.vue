<template>
  <v-container>
    ...
    <v-row>
      <v-col v-for="(item, index) in stalker.equipment" :key="index" cols="6">
        <v-card class="ma-2">
                ...
                <v-card class="pa-3" width="250">
                  ...
                  <v-form @submit.prevent="submit">
                    <v-text-field contained="true" name="name" label="Name" placeholder="name" style="min-width: 10rem;"
                      v-model="equipmentName" :rules="equipmentRule"></v-text-field>
                    ...
                    <v-text-field v-if="equipmentPersonal" contained="true" name="name" label="Stalker"
                      placeholder="name" style="min-width: 10rem;" v-model="equipmentStalker"></v-text-field>
                    <v-card-actions>
